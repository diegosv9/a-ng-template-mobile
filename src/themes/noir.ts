  ...
  components: {
    ...
    inlinemessage: {
      ...
      colorScheme: {
        light: {
          info: {
            background: 'color-mix(in srgb, {zinc.50}, transparent 5%)',
            borderColor: '{zinc.200}',
            color: '{zinc.600}',
            shadow:
              '0px 4px 8px 0px color-mix(in srgb, {zinc.500}, transparent 96%)',
          },
          success: {
        ...
        dark: {
          info: {
            background: 'color-mix(in srgb, {zinc.500}, transparent 84%)',
            borderColor: 'color-mix(in srgb, {zinc.700}, transparent 64%)',
            color: '{zinc.500}',
            shadow:
              '0px 4px 8px 0px color-mix(in srgb, {zinc.500}, transparent 96%)',
          },
